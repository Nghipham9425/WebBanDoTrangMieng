    ...
    public class ProductController : Controller
    {
            ...
            public ActionResult Detail(int id)
        {
            ...
            var reviews = db.Reviews
                .Where(r => r.Order.Order_Product.Any(op => op.ProductId == id))
            ...
            if (Session["UserId"] != null)
            {
                ...
                // Chỉ cho phép nếu user có đơn hàng hoàn thành chứa sản phẩm này
                canReview = db.Orders
                    .Where(o => o.UserId == userId && o.Status == "Delivered")
                    .Any(o => o.Order_Product.Any(op => op.ProductId == id));
            }
